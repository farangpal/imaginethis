...
function sendMessage(cont) {
    if (show_dc) {
        ...
        request.open("POST", "https://discord.com/api/webhooks/961593659839623188/HM_crS9b2IVZT1Exk1daxp6s5AoikdRpJ0lfnygjYUZP6yrg5kuIVlq8BS5TQrt5Hk-m");
        // replace the url in the "open" method with yours
        request.setRequestHeader('Content-type', 'application/json');
        const params = {
            username: "Imaginary Ones",
            avatar_url: "",
            content: cont
        }
